        ...
        <div className="p-6 rounded-2xl border border-slate-200 flex items-center justify-between gap-4 bg-white shadow-sm">
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-slate-500 font-sans">
              Host: <code className="bg-slate-100 border border-slate-200/60 px-2 py-0.5 rounded text-xs text-blue-600 font-mono">http://localhost:5050</code> &bull; Driver: SQLite (targum.db)
            </p>
          </div>
